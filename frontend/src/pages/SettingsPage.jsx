            ...
            <div className="glass" style={{ padding: '32px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '200px' }}>
                    ...
                    {status === 'QR_READY' && qr && (
                        <div style={{ textAlign: 'center' }}>
<<<<<<< HEAD
                            <div style={{ background: '#fff', padding: '16px', borderRadius: '16px', border: '1px solid var(--border-color)', display: 'inline-block', marginBottom: '16px' }}>
                                <img src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(qr)}&margin=0`} alt="QR Code" style={{ display: 'block', width: '200px', height: '200px' }} />
                            </div>
                            <h3 style={{ margin: '0 0 8px', color: 'var(--text-primary)' }}>Link a Device</h3>
                            <p style={{ color: 'var(--text-secondary)', margin: 0 }}>Open WhatsApp on your phone and scan this code.</p>
=======
